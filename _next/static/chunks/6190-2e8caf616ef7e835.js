  ...
  [6190],
  {
    20220: function (t, e, o) {
      ...
      e.Z = (t) =>
        (0, s.jsx)(a(), {
          animationData: n,
          style: { height: (null == t ? void 0 : t.height) || 16 },
        });
    },
    57323: function (t, e, o) {
      ...
      var s = o(52322),
        ...
        p = o(17129);
      let i = (t) => {
        window.gtag("config", "GTM-N2CNFFP", { page_path: t });
      };
      var f = o(24636),
        A = o(75926),
        m = o(92997);
    ...
    90930: function (t, e, o) {
      ...
      let s = {
        en: { title: "en", fullName: "English", disabled: !1, metaData: "" },
        ptbr: {
          title: "ptbr",
    ...
    67438: function (t, e, o) {
      ...
      let g = (t) => {
        ...
        return (0, s.jsxs)(c.z, {
          ...
          className: (0, A.m6)(
            "rounded-main flex flex-row gap-1 pl-3 pr-3",
            e.className
          ),
          onClick: () => {
            u((0, l.gb)(!0));
    ...
    69593: function (t, e, o) {
      ...
      let m = new Date().getFullYear().toString(),
        g = () =>
          (0, s.jsxs)("footer", {
            className: (0, f.m6)(
              "pt-15 grid items-center gap-4 pb-4 pl-11 pr-10",
              "[grid-template-areas:'logo_lang''social_social''copyright_copyright''links_links']",
              "lg:[grid-template-areas:'social_lang_lang_lang_lang''copyright_links_links_links_logo']",
              "xl:gap-8 xl:[grid-template-areas:'social_copyright_links_lang_logo']"
            ),
            children: [
              (0, s.jsx)(u, { className: "py-2 [grid-area:social] xl:py-0" }),
              (0, s.jsxs)(A.Z, {
                className: "text-sm [grid-area:copyright]",
                children: ["\xa9\xa0SingularityDAO\xa0", m],
              }),
              (0, s.jsx)(v, { className: "[grid-area:links]" }),
              (0, s.jsx)(d, { className: "ml-auto [grid-area:lang]" }),
              (0, s.jsx)(y, {
        ...
        u = (t) => {
          let { className: e } = t;
          return (0, s.jsx)("div", {
            className: (0, f.m6)("flex flex-row items-center gap-4", e),
            children: r.hR.map((t, e) =>
              (0, s.jsx)(
                "a",
                {
                  href: t.link,
        ...
        v = (t) => {
          let { className: e } = t,
            { t: o } = (0, l.$G)("common");
          return (0, s.jsxs)("div", {
            className: (0, f.m6)("flex flex-row gap-4", e),
            children: [
        ...
        d = (t) => {
          ...
          return (0, s.jsx)("div", {
            ...
            children: (0, s.jsxs)(i.z, {
              ...
              children: [
                (0, s.jsx)(p.J, { icon: "language", color: "#B4BCD0" }),
                (0, s.jsx)(A.Z, {
    ...
    1232: function (t, e, o) {
      ...
      let u = (t) => {
          ...
          return (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)(E, {
                ...
                target: u,
                className: (0, g.m6)(
                  "flex cursor-pointer flex-row items-center gap-2 transition-all duration-1000 ease-in-out",
                  !d.sideBarExpanded && "gap-1"
                ),
                onClick: () => {
                  h &&
                    y((t) => {
                      let e = !t,
                        o = !1 === d.sideBarExpanded;
                      return o && (d.setSideBarExpanded(!0), (e = !0)), e;
                    });
                },
                children: [
                  e,
                  (0, s.jsx)(A.U, {
                    visible: d.sideBarExpanded,
                    type: "horizontal",
                    children: (0, s.jsx)(a.Z, {
                      className:
                        "whitespace-nowrap text-sm font-bold text-[#F7F8F8]",
                      children: o,
                    }),
                  }),
                  h &&
                    (0, s.jsx)("div", {
                      className: (0, i.cx)(
                        ...
                        v && d.sideBarExpanded ? "rotate-0" : "-rotate-180"
                      ),
              ...
              h &&
                (0, s.jsx)(A.U, {
                  className: (0, i.cx)(!d.sideBarExpanded && "w-0"),
                  visible: d.sideBarExpanded && v,
                  type: "vertical",
                  children: (0, s.jsx)("div", {
                    className: "-mt-2 pb-2",
                    children: r.Children.map(l, (t) => t),
                  }),
                }),
            ],
          });
        ...
        v = (t) => {
          let { icon: e, active: o } = t;
          return (0, s.jsx)("div", {
            className: (0, g.m6)(
              (0, i.cx)("rounded-full bg-[#2B2B2B] p-2", o && "bg-[#2E5BFF]")
            ),
            children: (0, s.jsx)(m.J, {
              icon: e,
              height: 24,
        ...
        y = (t) => {
          let { active: e, label: o, href: r, target: n } = t;
          return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(p(), {
              ...
              children: (0, s.jsx)(a.Z, {
                className: (0, g.m6)(
                  (0, i.cx)(
                    "inline-block text-sm text-[#F7F8F8]",
                    e && "text-[#96ADFF]"
                  )
                ),
                children: o,
      ...
      let O = (t) => {
        ...
        return (0, s.jsx)("div", {
          style: o,
          className: (0, g.m6)((0, i.cx)("flex flex-col pr-2", e)),
            ...
            children: [
              A.map((t, e) =>
                (0, s.jsxs)(
                  ...
                  {
                    children: [
                      t.label && (0, s.jsx)(l, { children: t.label }),
                      t.items.map((t) => {
                        var e;
                        return (0, s.jsx)(
                          u,
              ...
              (0, s.jsx)("div", {
                ...
                children: (0, s.jsx)(u, {
                  ...
                  icon: (0, s.jsx)("div", {
                    className: (0, i.cx)(
                      "rounded-full border border-[#B4BCD0] p-2",
                      "transition-all duration-500 ease-in-out",
                      O.sideBarExpanded ? "-rotate-90" : "rotate-90"
                    ),
                    children: (0, s.jsx)(m.J, {
                      icon: "expand_less",
                      width: 22,
                ...
                return (0, s.jsx)(
                  r.Fragment,
                  {
                    children: n
                      ? (0, s.jsx)(a.Z, {
                          className:
                            "block text-sm text-[#B4BCD0] first-letter:uppercase",
                          children: t.label,
                        })
                      : (0, s.jsxs)(s.Fragment, {
                          children: [
      ...
      let D = function (t, e) {
        ...
        try {
          ...
          let s = encodeURIComponent(t) + "=" + encodeURIComponent(e);
          for (let t in o) {
            s += "; " + t;
            let e = o[t];
            !0 !== e && (s += "=" + e);
      ...
      var P = o(79168);
      let H = "SIDE_BAR_EXPANDED",
        z = (t) => {
          let { children: e, header: o, sidebar: a, breadcrumbs: n } = t,
            l = (0, r.useContext)(P.H),
            [c, p] = (0, r.useState)(!!l[H] && "1" === l[H]),
            A = (0, r.useCallback)((t) => {
              p(t), D(H, Number(t));
            }, []);
          return (0, s.jsx)(f.Provider, {
            value: { sideBarExpanded: c, setSideBarExpanded: A },
            children: (0, s.jsxs)("div", {
              className: "x-layout",
              children: [
                o,
                (0, s.jsxs)("div", {
                  className: (0, i.cx)("x-content flex pl-11 pr-10"),
                  children: [
                    a && (0, s.jsx)(O, {}),
                    (0, s.jsxs)("main", {
                      className: (0, i.cx)(
                        "x-main mx-auto max-w-[1600px] flex-grow pt-3",
                        a && "pl-11"
                      ),
                      children: [
                        n &&
    ...
    77466: function (t, e, o) {
      ...
      let l = (t) => {
        ...
        return (0, s.jsxs)("header", {
          className:
            "flex w-full items-center justify-between pl-12 pr-10 pt-4",
          children: [
            (0, s.jsx)(a(), {
              href: "/",
              children: (0, s.jsx)("img", {
            ...
            (0, s.jsx)("div", {
              children: (0, s.jsx)(n.T, {
                className:
                  "flex items-center gap-3 border-0 bg-[linear-gradient(136.19deg,_#363636_0%,_rgba(26,_26,_26,_0.5)_100%)] px-4 py-2.5",
                children: e,
              }),
            }),
          ],
    ...
    12849: function (t, e, o) {
      ...
      let s = (t, e) => (t.isActive ? t.isActive(t, e) : e.startsWith(t.href)),
        r = (t, e) => t.href === e,
        a = (t, e) => t.some((t) => t.href && e.startsWith(t.href)),
        n = (t, e) => s(t, e) || a(t.items || [], e),
        l = (t, e) =>
          !0 === e.hidden
            ? t
            : e.items && 0 !== e.items.length
            ? [...t, { ...e, items: e.items.reduce(l, []) }]
            : [...t, e];
    },
    3866: function (t, e, o) {
      o.d(e, {
      ...
      let a = (t) => {
          let e = [
            s.e.featureFlags.DYNAMIC_STAKING
              ? {
                  label: t("MENU.ASI_TERMINAL"),
                  items: [
                    {
                      label: t("MENU.DYNAMIC_STAKING"),
                      icon: "coins",
                      href: "/staking/projects",
                      hidden: !s.e.featureFlags.DYNAMIC_STAKING,
                    },
                    {
                      label: t("MENU.MIGRATE_ASI"),
                      icon: "migrate_asi",
                      href: "/migrate-asi",
                      isActive: r.Dj,
                    },
                  ...
                  items: [
                    {
                      ...
                      href: s.e.featureFlags.portfolio ? "/pv2/portfolio" : "/",
                    },
                  ],
                },
            {
              label: "Earn",
              items: [
                { label: "Liquidity", icon: "liquidity", href: "/pools" },
                { label: "Claim", icon: "claim", href: "/claim" },
              ],
            },
          ...
          let e = [
                ...
                },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  icon: "dynasets",
                  items: [
                    { label: "Dynamic", href: "/dynasets" },
                    { label: "DynaLab", href: "/dynalab" },
                  ],
                },
                {
                  label: "Vaults",
                  icon: "vault",
                  items: [
                    { label: "Epoch", href: "/vaults/epochvaults" },
                    { label: "Unbonded", href: "/vaults/unbondedvaults" },
                    { label: "Yield", href: "/vaults/yieldvaults" },
                  ],
                },
                { label: "Liquidity", icon: "liquidity", href: "/pools" },
                { label: "Claim", icon: "claim", href: "/claim" },
            ...
            },
            {
              ...
              items: [
                ...
                { label: "Swap", icon: "exchange", href: "/swap" },
                {
                  label: "Migrate",
                  icon: "migrate",
                  href: "/migrate",
    ...
    12522: function (t, e, o) {
      ...
      var s = o(52322),
        ...
        p = o(32377),
        i = o(82857);
      let f = r.createContext({ menuOpen: !0, setMenuOpen: (t) => {} });
      var A = o(78246),
        m = o(67438),
        g = o(98614),
        u = o(17129),
      ...
      let h = () => {
          let { t } = (0, g.$G)("common"),
            ...
            o = (0, v.mA)(),
            r = (0, d.Z)();
          return o.isConnected && r
            ? (0, s.jsx)(m.w, {
                button: { style: "ghost", className: "bg-[#191A1E]" },
              })
            : (0, s.jsx)(A.z, {
                size: "small",
                onClick: () => {
        ...
        E = () => {
          ...
          return (0, s.jsxs)("header", {
            className:
              "flex w-full flex-row items-center justify-between rounded-[56px] bg-[radial-gradient(35.96%_965.71%_at_54.93%_-273.57%,_#363636_0%,_rgba(54,_54,_54,_0.27)_100%)] px-3 py-2",
            children: [
              (0, s.jsx)("div", {
                children: (0, s.jsx)(c(), {
                  href: "/",
              ...
              (0, s.jsx)("div", {
                children: (0, s.jsx)(p.E, {
                  ...
                  children: (0, s.jsx)(i.J, { icon: "menu", color: "#B4BCD0" }),
                }),
              }),
            ],
          });
      ...
      var C = o(57143);
      let O = (t) => {
        let { open: e, onOpenChange: o, children: r } = t;
        return (0, s.jsx)(C.k.Root, {
          open: e,
          onOpenChange: o,
          children: (0, s.jsxs)(C.k.Content, {
            variant: "unstyled",
            className:
              "absolute left-0 top-0 mt-0 translate-x-0 translate-y-0 bg-[#020002] pb-0",
            fullscreen: !0,
            children: [
              (0, s.jsx)(C.k.Body, {
                variant: "unstyled",
      ...
      let x = (t) => {
        ...
        return (
          ...
          (0, s.jsxs)(f.Provider, {
            value: { menuOpen: e, setMenuOpen: o },
            children: [
              (0, s.jsxs)("div", {
                className: "flex flex-col",
                children: [
                  ...
                  (0, s.jsx)("div", {
                    ...
                    children: (0, s.jsx)(b.S, { children: l }),
                  }),
                  (0, s.jsx)(w.$, {}),
                ],
              }),
          ...
          children: [
            (0, s.jsx)("div", {
              ...
              children: (0, s.jsxs)(h, {
                ...
                target: m,
                className:
                  "flex flex-row items-center gap-2.5 py-1.5 pl-2.5 pr-2",
                onClick: () => {
                  d && y((t) => !t);
                },
                children: [
                  ...
                  (0, s.jsx)(l.Z, {
                    className:
                      "whitespace-nowrap text-sm font-bold text-inherit",
                    children: o,
                  }),
                  u && u,
                  d &&
    ...
    44149: function (t, e, o) {
      ...
      e.Z = function (t) {
        ...
        return (0, s.jsx)("div", {
          ...
          children: (0, s.jsxs)("div", {
            children: [
              (0, s.jsx)(r.Z, { height: 200, width: 200 }),
              (0, s.jsx)("div", {
    ...
    24636: function (t, e, o) {
      ...
      let a = (t, e, o, s, a) => {
        ...
        n = (t, e) => {
          r().dataLayer({
            dataLayer: { event: "pageview", pagePath: t, pageTitle: e },
          });
        };
    },
    78246: function (t, e, o) {
      ...
      let c = (0, a.j)(
          (0, n.m6)(
            ...
            "fontMontserrat text-white font-normal",
            "border-transparent border border-solid focus:border-[#FFFFFF]",
            "box-border",
            "rounded-main active:bg-[#767DFF] "
          ),
          {
            variants: {
              size: {
            ...
            defaultVariants: { size: "medium", style: "neutral" },
          }
        ),
        p = r.forwardRef(function (t, e) {
          let {
            ...
            d = (0, n.m6)(c({ size: a, style: p, disabled: r }), f),
            h = r ? () => {} : y;
          return (0,
          s.jsxs)(m, { ref: e, id: o, href: g, target: u, type: v, className: d, onClick: h, children: [i, A && (0, s.jsx)(l.Q, { className: "ml-1", $size: "14px", $borderWidth: "3px" })] });
        });
    },
    32377: function (t, e, o) {
      ...
      let n = r.forwardRef(function (t, e) {
        let {
          ...
          p = (0, a.m6)(
            "flex flex-row justify-center font-bold py-2 px-2 rounded-full box-border text-sm font-normal",
            r ? "cursor-not-allowed bg-[#9EABCA]" : "hover:bg-[#231D32]",
            n
          ),
          i = r ? () => {} : l;
        return (0,
        s.jsx)("button", { ref: e, id: o, className: p, onClick: i, children: c });
      });
    },
    72543: function (t, e, o) {
      ...
      var s = o(52322),
        ...
        n = o(20324);
      let l = (t) => {
        let { className: e, visible: o, type: l = "vertical", children: c } = t,
          p = (0, r.useRef)(null),
          i = (0, r.useRef)(null);
        return (
          (0, r.useEffect)(() => {
      ...
      let su = {
              ...
              eo ||
                (eo = eU.createElement(
                  ...
                  eU.createElement(
                    ...
                    eU.createElement("stop", { stopColor: "#4CC8F4" }),
          ...
          buy_sdao: function (t) {
            return eU.createElement(
              ...
              eU.createElement(
                ...
                ey ||
                  (ey = eU.createElement("path", {
                    fill: "url(#buy_sdao_svg__h)",
                    d: "M17.025 10.928c-1.027 0-2.008-.407-2.693-1.118-.706-.734-1.049-1.685-.99-2.751a4.2 4.2 0 0 1 .489-1.743c.35-.663.817-1.2 1.386-1.597.41-.286.842-.482 1.284-.58.136-.031.34-.07.554-.066a3.97 3.97 0 0 1 2.805 1.263 3.93 3.93 0 0 1 1.074 2.73 3.9 3.9 0 0 1-1.14 2.711 3.87 3.87 0 0 1-2.743 1.151zm-.003-7.833c-.2 0-.388.037-.516.066a3.6 3.6 0 0 0-1.276.577c-.566.395-1.03.93-1.379 1.59a4.2 4.2 0 0 0-.485 1.733c-.059 1.06.281 2.005.983 2.733.687.713 1.671 1.119 2.702 1.111a3.85 3.85 0 0 0 2.728-1.144 3.87 3.87 0 0 0 .064-5.41 3.95 3.95 0 0 0-2.788-1.255z",
                    opacity: 0.94,
                  })),
                ed ||
                  (ed = eU.createElement("path", {
          ...
          ellipse: function (t) {
            return eU.createElement(
              ...
              eW || (eW = eU.createElement("circle", { cx: 4, cy: 4, r: 4 }))
            );
          },
          coins: function (t) {
            return eU.createElement(
              ...
              eZ ||
                (eZ = eU.createElement("path", {
                  fill: "#B4BCD0",
                  d: "M21 8c0 1.02-1.186 1.92-3 2.462-1.134.34-2.513.538-4 .538s-2.866-.199-4-.538C8.187 9.92 7 9.02 7 8c0-1.657 3.134-3 7-3s7 1.343 7 3",
                })),
              eM ||
                (eM = eU.createElement("path", {
                  stroke: "#B4BCD0",
    ...
    61352: function (t, e, o) {
      ...
      var r = o(61335),
        a = o(20324);
      let n = (0, r.j)((0, a.m6)("border border-solid"), {
          variants: {
            style: {
              default:
                "inline-flex rounded-main bg-[linear-gradient(136.19deg,_#363636_0%,_rgba(26,_26,_26,_0.5)_100%)]",
            },
            outline: {
          ...
          defaultVariants: { style: "default", outline: "default" },
        }),
        l = (t) => {
          let { className: e, style: o, outline: r, children: l } = t,
            c = (0, a.m6)(n({ style: o, outline: r }), e);
          return (0, s.jsx)("div", { className: c, children: l });
        };
    },
    61135: function (t, e, o) {
      ...
      var r = o(20324);
      function a(t) {
        let { children: e, className: o, as: a = "span" } = t,
          n = (0, r.m6)("fontMontserrat text-white text-lg", o);
        return (0, s.jsx)(a, { className: n, children: e });
      }
    },
    92677: function (t) {
